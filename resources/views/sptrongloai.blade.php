		...
		<div class="row">
			...
			<div class="col-xl-9 col-lg-8 col-md-7">
				...
				<div class="filter-bar d-flex flex-wrap align-items-center">
					<a href=""> {{ $listsp->onEachSide(5)->links() }} </a>
				</div>
				<!-- End Filter Bar -->
				<!-- Start Best Seller -->
					...
					<div class="row">
                        ...
                        @foreach ($listsp as $sp )
                            <div class="col-lg-4 col-md-6">
                                ...
                                <a href="/sp/{{$sp->id_sp}}"><img class="img-fluid" src="{{ asset('img/produc') }}t/p1.jpg" alt=""></a>
			...
			<div class="row">
				<div class="col-lg-9">
					<div class="row">
						...
						<div class="col-lg-4 col-md-4 col-sm-6">
							<div class="single-related-product d-flex">
								<a href="#"><img src="{{ asset('img/r10.jp') }}g" alt=""></a>
								<div class="desc">
									<a href="#" class="title">Black lace Heels</a>
									<div class="price">
										<h6>$189.00</h6>
						...
						<div class="col-lg-4 col-md-4 col-sm-6">
							<div class="single-related-product d-flex">
								<a href="#"><img src="{{ asset('img/r11.jp') }}g" alt=""></a>
								<div class="desc">
									<a href="#" class="title">Black lace Heels</a>
									<div class="price">
										<h6>$189.00</h6>
				...
				<div class="col-lg-3">
					<div class="ctg-right">
						<a href="#" target="_blank">
							<img class="img-fluid d-block mx-auto" src="{{ asset('img/catego') }}ry/c5.jpg" alt="">
						</a>
					</div>
				</div>
			</div>
